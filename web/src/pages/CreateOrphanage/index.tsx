      ...
      <main>
        <form onSubmit={handleSubmit} className="create-orphanage-form">
          <fieldset>
            ...
            <Map 
              center={[-23.1942022,-45.8859192]} 
              style={{ width: '100%', height: 280, marginBottom: 48, borderRadius: 20 }}
              zoom={12}
            ...
            <div className="input-block">
              ...
              <input style={{display: 'none'}} type="file" id="image[]" multiple onChange={handleSelectImages} />
            </div>
          </fieldset>
